package com.shenjies88.leetCodePractice.dp.interview.t17_16;
...
/**
 * @author shenjies88
 * @since 2020/09/17/17:23
 */
public class TheMasseuse {
    public static void main(String[] args) {
        System.out.println(new TheMasseuse().massage(new int[]{2, 1, 4, 5, 3, 1, 1, 3}));//12
        System.out.println(new TheMasseuse().massage(new int[]{1, 2, 3, 1}));//4
        System.out.println(new TheMasseuse().massage(new int[]{2, 7, 9, 3, 1}));//12
    }
